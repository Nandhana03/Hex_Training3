...
public class CustomerController {
	...
	@GetMapping("/customers/minBalance/{amount}")
    public List<Customer> getByMinBalance(@PathVariable double amount) {
        return service.getByMinBalance(amount);
    }

//    @PutMapping("/updatedataAc/{ac}")
//    public Customer updateByAct(@PathVariable int ac, double amt)
//    {
//    	 
//    }
    
	@PutMapping("/updatedataAc/{ac}")
	public Customer updateByAct(@PathVariable int ac, @RequestParam double amt) {
	    return service.updateCustomer(ac, amt);
	}
	...
	public int DeleteAct(@PathVariable int ac) {
